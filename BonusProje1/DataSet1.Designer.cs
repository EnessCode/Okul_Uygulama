...
namespace BonusProje1.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBLOGRENCİLER.OGRID, TBLOGRENCİLER.OGRAD, TBLOGRENCİLER.OGRSOYAD, TBLOGREN" +
                "CİLER.OGRCİNSİYET, TBLKULUPLER.KULUPAD\r\nFROM     TBLOGRENCİLER INNER JOIN\r\n     " +
                "             TBLKULUPLER ON TBLOGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT TBLOGRENCİLER.OGRID, TBLOGRENCİLER.OGRAD, TBLOGRENCİLER.OGRSOYAD, TBLOGRENCİLER.OGRCİNSİYET, TBLKULUPLER.KULUPAD
FROM     TBLOGRENCİLER INNER JOIN
                  TBLKULUPLER ON TBLOGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE  (TBLOGRENCİLER.OGRAD = @OGRAD)";
            ...
            this._commandCollection[3].CommandText = "UPDATE TBLOGRENCİLER\r\nSET          OGRAD = @OGRAD, OGRSOYAD = @OGRSOYAD, OGRKULUP" +
                " = @OGRKULUP, OGRCİNSİYET = @OGRCİNSİYET where OGRID=@OGRID";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrenciGüncelle(string OGRAD, string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, string OGRCİNSİYET, int OGRID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
